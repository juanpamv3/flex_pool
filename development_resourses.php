...
<? include 'header.php'; ?>
        ...
        <div class="col-sm-12 developmentResoursesBlock"><!-- availables resourses BOX -->
          ...
          <?php
            $sql = "SELECT id, name, country, role, skills, availability FROM profiles WHERE category = 3";
