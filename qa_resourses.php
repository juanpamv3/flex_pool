...
if ($mysqli->connect_errno) {
 ...
 <? include 'header.php'; ?>
        ...
        <div class="col-sm-12 qaResoursesBlock"><!-- availables resourses BOX -->
          ...
          <div class="col-sm-12">
            ...
            <?php
            $sql = "SELECT id, name, country, role, skills, availability FROM profiles WHERE category = 4";
                        ...
                        echo '<div class="col-sm-12 resourse1">
                          ...
                          <div class="col-sm-3">
                            <a href="profile.php?id='. $row["id"].'">
                              <p class="qaHighlight">'. $row["role"].'</p>
                            </a>
                          </div>
                          <div class="col-sm-8">
                            <p>'. $row["skills"].'</p>
